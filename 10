...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    switch (data)
    {
      case 'a': digitalWrite(13, HIGH); digitalWrite(12, HIGH); analogWrite(10, 255); break; // Datuaren balioaren arabera aukera desberdinak egin
      case 'b': digitalWrite(13, LOW); analogWrite(10, 0);break;
      default : break;
    }
  }
  delay(50);
